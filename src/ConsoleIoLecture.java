...
//
//        String name = "Ryan";
//        System.out.printf("Hello %s%n", name); //Hello Ryan
...
//        int five = 5;
//        String workWeek = "days in a work week";
//
//        System.out.printf("There's %d %s.%n", five, workWeek);
